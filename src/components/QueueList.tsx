          ...
          >
            <div className="flex items-start justify-between">
              ...
              <button
                ...
                className="px-3 py-1.5 bg-red-900/30 border border-red-800 hover:bg-red-900/50 text-red-400 text-sm rounded-lg transition-colors"
              >
                {leaving === entry.id ? "Leaving..." : "Leave Queue"}
              </button>
            </div>
          </div>
        );
